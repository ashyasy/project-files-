...
void generateRandomArray(std::vector<int>& array, int range) {
...
int main() {
    ...
    // Part 2: Performance Testing and Writing to File
    ...
    outputFile.close();
    std::cout << "Performance data written to output.csv" << std::endl;
